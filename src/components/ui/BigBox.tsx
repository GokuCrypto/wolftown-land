...
export const BigBox: React.FC<BoxProps> = ({
  image,
  secondaryImage,
  isSelected,
  count,
    ...
    >
      <div
        className={classNames(
          "bigbox bg-brown-600  m-1.5 cursor-pointer flex items-center justify-center relative",
          {
      ...
      {(isSelected) && !locked && !disabled && (
        <img
          className="absolute bigbox-selected top-0.5 left-0.5 pointer-events-none"
          src={selectBox}
        />
      )}
    </div>
