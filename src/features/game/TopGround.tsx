...
export const TopGround: React.FC = () => {
    ...
    return (
        <BottomDiv className="bg-brown-600 shadow-lg" style={{ backgroundImage: `url(${backgroundImages})`, backgroundSize: "cover", backgroundRepeat: "no-repeat", height: isMobile ? "41px" : "60px", zIndex: 1 }}>
            <div style={{ position: "relative", width: "100%", height: "100%" }}>
                <Avatarframe>
                {/* <img src={logoImage} className="logo" alt="Logo" style={{ position: "absolute", top: 0, left: 0, width: "10%", height: "100%" }} /> */}
                <img src={avatarImage} className="avatar" alt="Avatar" style={{ position: "absolute", top: 0, left: 0, }} />
                </Avatarframe>                
